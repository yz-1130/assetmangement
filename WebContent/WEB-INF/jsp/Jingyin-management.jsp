 ...
 <meta charset="UTF-8"><title>assetmangement</title>
   <link rel="stylesheet" href="${pageContext.request.contextPath}/css/table.css"/>
    ...
    <script type="text/javascript">
        function add() {
            debugger
            window.location.href="/Jingyin-insert.do";
...
<form action="selectJingyin.do" method="post">
<div class="whole">
...
<div class="main">
    ...
    <span style="color: red; display: block;margin-left:20px; margin-top: 10px; white-space: nowrap;">
                   金银首饰价值总额： <span> ${totalAssetsAmount}</span> 元</span>
...
<td>
<a href="${pageContext.request.contextPath}/gotoUpdateJingyin.do?id=${b2.id}" >修改</a>&nbsp;
<a href="${pageContext.request.contextPath}/deleteJingyin.do?id=${b2.id}" >删除</a>
</td>		
			</tr>
		</c:forEach>
        </tbody>
