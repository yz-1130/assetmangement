...
购买类型:<input type="text" placeholder="按购买类型查询" name="leixing" class="text">&nbsp;&nbsp;
  ...
  <img src="${pageContext.request.contextPath}/images/add.png" class="img2">&nbsp;<a href="Jijin-insert.do">新增</a>&nbsp;&nbsp;
...
<a href="${pageContext.request.contextPath}/deleteJijin.do?id=${b2.id}" >删除</a>
</td>		
			</tr>
		</c:forEach>
        </tbody>
