...
<tr>
	<td class="title">购入日期:</td>
 	<td class="edit"><input type="text" class="txt" name="jine" value="${b2.jine}" id="datetimepicker1"autocomplete="off"> </td>
</tr>
    </p>
<tr>
...
<tr>
    ...
    <tr>
        ...
        <td class="edit"><input type="text" class="txt" name="planDate" value="${b2.planDate}" id="datetimepicker2"autocomplete="off"> </td>
    </tr>
    </p>
<tr>
