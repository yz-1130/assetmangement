...
<form action="updateJijin.do?id=${b2.id}" method="post" id="form">
<tr>
...
<tr>
	<td class="title">定投金额:</td>
 	<td class="edit"><input type="text" class="txt" name="jine" value="${b2.jine}" v> </td>
</tr> </p>
<tr>
    ...
    <tr>
        ...
        <td class="edit"><input type="text" class="txt" name="planDate" value="${b2.planDate}" id="datetimepicker1"> </td>
    </tr>
    </p>
<tr>
